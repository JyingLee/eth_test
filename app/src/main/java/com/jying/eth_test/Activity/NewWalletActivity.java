...
//        Credentials credentials = Credentials.create("DED5206446CCAF127ACE7DE199B9E629FF26BC7A0DBD173A169A106616B92EFB");
        ...
        switch (requestCode) {
            case 123:
                if (grantResults.length == 0 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(NewWalletActivity.this, "获取权限失败", Toast.LENGTH_SHORT).show();
                } else {
